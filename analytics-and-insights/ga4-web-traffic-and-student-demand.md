...
The underlying BigQuery GA4 unbundled PDF reports are preserved in the workspace directory `web-reports/` (dated snapshot `2026-09-02` to enable longitudinal comparison against future reporting periods):
*   `web-reports/ste-home_2026-09-02.pdf` (5 pages - Core STE portal analytics)
*   `web-reports/eled_2026-09-02.pdf` (8 pages - Elementary education major metrics)
*   `web-reports/become-a-teacher_2026-09-02.pdf` (8 pages - Prospective recruitment funnel)
*   `web-reports/SPED_2026-09-02.pdf` (5 pages - Special education metrics)
*   `web-reports/mged_2026-09-02.pdf` (5 pages - Middle grades education metrics)
*   `web-reports/iece_2026-09-02.pdf` (5 pages - Early childhood metrics)
*   `web-reports/literacy_2026-09-02.pdf` (4 pages - Literacy program metrics)
*   `web-reports/id_2026-09-02.pdf` (5 pages - Instructional design metrics)
*   `web-reports/Libraries, Informatics, and Technology in Education_2026-09-02.pdf` (5 pages - LITE metrics)
